...
pub fn hetprob(
    ...
    let p0h2o = (18.452_406_985 - 3_505.157_880_7 / t - 330_918.550_82 / (t * t)
    ...
    let ah = (60.51 - 0.095 * wt + 0.0077 * wt * wt
        - 1.61e-5 * wt * wt * wt
    ...
    let hhcl =
        (0.094 - 0.61 * x + 1.2 * x * x) * (-8.68 + (8515.0 - 10718.0 * x.powf(0.7)) / t).exp();
    let mhcl = hhcl * phcl;
    ...
    let ghobrrxn =
        ghoclrxn * (c_hocl / c_hobr) * ((khobr_hcl + khobr_hbr) / khocl_hcl).sqrt() * 10.0;
