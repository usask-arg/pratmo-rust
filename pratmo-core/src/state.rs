...
pub struct ModelState {
    ...
    pub nnr: usize,
    pub ntsav: [usize; NDEN + 1],
    pub nflo: [i32; 20],        // explicit integration flags per species
    pub tname: [String; NDEN],  // species names for Newton-Raphson set
    pub tnamet: [String; NDEN], // transient species names
...
impl Clone for ModelState {
    fn clone(&self) -> Self {
        Self {
            title0: self.title0.clone(),
            titlev: self.titlev.clone(),
            titlej: self.titlej.clone(),
            t: self.t.clone(),
            refo3: self.refo3.clone(),
            pstd: self.pstd.clone(),
            dm: self.dm.clone(),
            do3ref: self.do3ref.clone(),
            z: self.z.clone(),
            theta: self.theta.clone(),
            aer: self.aer.clone(),
            do3int: self.do3int.clone(),
            wtau: self.wtau.clone(),
            dnoy_ref: self.dnoy_ref.clone(),
            rflect: self.rflect.clone(),
            sza: self.sza.clone(),
            u0: self.u0.clone(),
            ...
            pn2: self.pn2.clone(),
            po2: self.po2.clone(),
            pco2: self.pco2.clone(),
            rad: self.rad.clone(),
            grav: self.grav.clone(),
            zzht: self.zzht.clone(),
            xlat: self.xlat.clone(),
            xdec: self.xdec.clone(),
            xlatd: self.xlatd.clone(),
            xdecd: self.xdecd.clone(),
            atime: self.atime.clone(),
            btime: self.btime.clone(),
            clouds: self.clouds.clone(),
            turbd0: self.turbd0.clone(),
            turbdx: self.turbdx.clone(),
            flscal: self.flscal.clone(),
            tau: self.tau.clone(),
            piray: self.piray.clone(),
            piaer: self.piaer.clone(),
            fltau: self.fltau.clone(),
            ttfbot: self.ttfbot.clone(),
            ntt: self.ntt.clone(),
            xnold: self.xnold.clone(),
            deltt: self.deltt.clone(),
            gmu: self.gmu.clone(),
            ittt: self.ittt.clone(),
            ialt: self.ialt.clone(),
            ibox: self.ibox.clone(),
            dno: self.dno.clone(),
            dno2: self.dno2.clone(),
            dno3: self.dno3.clone(),
            dn2o5: self.dn2o5.clone(),
            dhno3: self.dhno3.clone(),
            dh: self.dh.clone(),
            doh: self.doh.clone(),
            dho2: self.dho2.clone(),
            dh2o2: self.dh2o2.clone(),
            do_: self.do_.clone(),
            do3: self.do3.clone(),
            dbro: self.dbro.clone(),
            dbr: self.dbr.clone(),
            dhbr: self.dhbr.clone(),
            dhno2: self.dhno2.clone(),
            dhcl: self.dhcl.clone(),
            dcl: self.dcl.clone(),
            dcl2: self.dcl2.clone(),
            dclo: self.dclo.clone(),
            dclno3: self.dclno3.clone(),
            dhno4: self.dhno4.clone(),
            dhocl: self.dhocl.clone(),
            dbrno3: self.dbrno3.clone(),
            dhobr: self.dhobr.clone(),
            dh2co: self.dh2co.clone(),
            droo: self.droo.clone(),
            drooh: self.drooh.clone(),
            doclo: self.doclo.clone(),
            dcl2o2: self.dcl2o2.clone(),
            dbrcl: self.dbrcl.clone(),
            di_: self.di_.clone(),
            dio: self.dio.clone(),
            dhoi: self.dhoi.clone(),
            diono2: self.diono2.clone(),
            dhi: self.dhi.clone(),
            doio: self.doio.clone(),
            di2: self.di2.clone(),
            di2o2: self.di2o2.clone(),
            di2o3: self.di2o3.clone(),
            di2o4: self.di2o4.clone(),
            fo3: self.fo3.clone(),
            fn2o: self.fn2o.clone(),
            fnoy: self.fnoy.clone(),
            fch4: self.fch4.clone(),
            fco: self.fco.clone(),
            fclx: self.fclx.clone(),
            fcf2cl: self.fcf2cl.clone(),
            fcfcl3: self.fcfcl3.clone(),
            fccl4: self.fccl4.clone(),
            fch3cl: self.fch3cl.clone(),
            fmecl: self.fmecl.clone(),
            fh2: self.fh2.clone(),
            fh2o: self.fh2o.clone(),
            fnh3: self.fnh3.clone(),
            fc5h8: self.fc5h8.clone(),
            fbrx: self.fbrx.clone(),
            ...
            ndval: self.ndval.clone(),
            nfval: self.nfval.clone(),
            wbin: self.wbin.clone(),
            wl: self.wl.clone(),
            fl: self.fl.clone(),
            qo2: self.qo2.clone(),
            o2x: self.o2x.clone(),
            ...
            qqq: self.qqq.clone(),
            tqq: self.tqq.clone(),
            qmi1m: self.qmi1m.clone(),
            qmiwvl: self.qmiwvl.clone(),
            nw1: self.nw1.clone(),
            nw2: self.nw2.clone(),
            nwsrb: self.nwsrb.clone(),
            nsr: self.nsr.clone(),
            nodf: self.nodf.clone(),
            isr: self.isr.clone(),
            vno: self.vno.clone(),
            vo2: self.vo2.clone(),
            vo3: self.vo3.clone(),
            vo3d: self.vo3d.clone(),
            vh2coa: self.vh2coa.clone(),
            vh2cob: self.vh2cob.clone(),
            vh2o2: self.vh2o2.clone(),
            vrooh: self.vrooh.clone(),
            vno2: self.vno2.clone(),
            vno3x: self.vno3x.clone(),
            vno3l: self.vno3l.clone(),
            vn2o5: self.vn2o5.clone(),
            vhno2: self.vhno2.clone(),
            vhno3: self.vhno3.clone(),
            vhno4: self.vhno4.clone(),
            vclno3: self.vclno3.clone(),
            vcl2: self.vcl2.clone(),
            vhocl: self.vhocl.clone(),
            voclo: self.voclo.clone(),
            vcl2o2: self.vcl2o2.clone(),
            vclo: self.vclo.clone(),
            vbro: self.vbro.clone(),
            vbrno3: self.vbrno3.clone(),
            vhobr: self.vhobr.clone(),
            vn2o: self.vn2o.clone(),
            vcfcl3: self.vcfcl3.clone(),
            vf2cl2: self.vf2cl2.clone(),
            vf113: self.vf113.clone(),
            vf114: self.vf114.clone(),
            vf115: self.vf115.clone(),
            vccl4: self.vccl4.clone(),
            vch3cl: self.vch3cl.clone(),
            vmecf: self.vmecf.clone(),
            vch3br: self.vch3br.clone(),
            vh1211: self.vh1211.clone(),
            vh1301: self.vh1301.clone(),
            vh2402: self.vh2402.clone(),
            vh22: self.vh22.clone(),
            vh123: self.vh123.clone(),
            vh141b: self.vh141b.clone(),
            vchbr3: self.vchbr3.clone(),
            vch3i: self.vch3i.clone(),
            vcf3i: self.vcf3i.clone(),
            vocs: self.vocs.clone(),
            vio: self.vio.clone(),
            vhoi: self.vhoi.clone(),
            viono2: self.viono2.clone(),
            voio: self.voio.clone(),
            vi2: self.vi2.clone(),
            vi2o2: self.vi2o2.clone(),
            vi2o3: self.vi2o3.clone(),
            vi2o4: self.vi2o4.clone(),
            fff: self.fff.clone(),
            njval: self.njval.clone(),
            n: self.n.clone(),
            ntot: self.ntot.clone(),
            ntotx: self.ntotx.clone(),
            nnrt: self.nnrt.clone(),
            nnr: self.nnr.clone(),
            ntsav: self.ntsav.clone(),
            nflo: self.nflo.clone(),
            tname: self.tname.clone(),
            tnamet: self.tnamet.clone(),
            tnomf: self.tnomf.clone(),
            xr: self.xr.clone(),
            r: self.r.clone(),
            rp: self.rp.clone(),
            rl: self.rl.clone(),
            ...
            rlf: self.rlf.clone(),
            rqf: self.rqf.clone(),
            pmean: self.pmean.clone(),
            xnoft: self.xnoft.clone(),
            ppmean: self.ppmean.clone(),
            xxnoft: self.xxnoft.clone(),
            storjv: self.storjv.clone(),
            ndxpp: self.ndxpp.clone(),
            ndxqq: self.ndxqq.clone(),
            rk: self.rk.clone(),
            rfmt: self.rfmt.clone(),
            rfmt_str: self.rfmt_str.clone(),
            rkadd: self.rkadd.clone(),
            ndxrat: self.ndxrat.clone(),
            nrates: self.nrates.clone(),
            nrate1: self.nrate1.clone(),
            rk0: self.rk0.clone(),
            ratek: self.ratek.clone(),
            ztemp: self.ztemp.clone(),
            zdnum: self.zdnum.clone(),
            zalt: self.zalt.clone(),
            izalt: self.izalt.clone(),
            a_mat: self.a_mat.clone(),
            ipa: self.ipa.clone(),
            astore: self.astore.clone(),
            aextra: self.aextra.clone(),
            dtime: self.dtime.clone(),
            wtime: self.wtime.clone(),
            utime: self.utime.clone(),
            ztime: self.ztime.clone(),
            gmu0: self.gmu0.clone(),
            daysec: self.daysec.clone(),
            sunset: self.sunset.clone(),
            jtim: self.jtim.clone(),
            nhhmm: self.nhhmm.clone(),
            ntim: self.ntim.clone(),
            nmu: self.nmu.clone(),
            ntimdo: self.ntimdo.clone(),
            rafmin: self.rafmin.clone(),
            rafmax: self.rafmax.clone(),
            rafpml: self.rafpml.clone(),
            rafeps: self.rafeps.clone(),
            raferr: self.raferr.clone(),
            dayeps: self.dayeps.clone(),
            ...
            nboxwt: self.nboxwt.clone(),
            nboxct: self.nboxct.clone(),
            nprt1: self.nprt1.clone(),
            nprt2: self.nprt2.clone(),
            nprtrr: self.nprtrr.clone(),
            itprtx: self.itprtx.clone(),
            itprtr: self.itprtr.clone(),
            itprtb: self.itprtb.clone(),
            nday: self.nday.clone(),
            ndaysd: self.ndaysd.clone(),
            npstd: self.npstd.clone(),
            tdiff: self.tdiff.clone(),
            xdmax: self.xdmax.clone(),
            zshear: self.zshear.clone(),
            diffac: self.diffac.clone(),
            ndiff: self.ndiff.clone(),
            lprt: self.lprt.clone(),
            lprtx: self.lprtx.clone(),
            lprts: self.lprts.clone(),
            ldiurn: self.ldiurn.clone(),
            ljzer: self.ljzer.clone(),
            lbrom: self.lbrom.clone(),
            liod: self.liod.clone(),
            lsvjac: self.lsvjac.clone(),
            lsvday: self.lsvday.clone(),
            lend: self.lend.clone(),
            lprtjv: self.lprtjv.clone(),
            ...
            rampm: self.rampm.clone(),
            aersf: self.aersf.clone(),
            smxsf: self.smxsf.clone(),
            ssf: self.ssf.clone(),
            coclo: self.coclo.clone(),
            cbro: self.cbro.clone(),
            cno2: self.cno2.clone(),
            cno3: self.cno3.clone(),
            cclo: self.cclo.clone(),
            chono: self.chono.clone(),
            xpo3: self.xpo3.clone(),
            xlo3: self.xlo3.clone(),
            do2int: self.do2int.clone(),
            o3tr: self.o3tr.clone(),
            ztr: self.ztr.clone(),
            watalb: self.watalb.clone(),
            wvalb: self.wvalb.clone(),
            szalb: self.szalb.clone(),
            ztalb: self.ztalb.clone(),
            dn2oref: self.dn2oref.clone(),
            tinp: self.tinp.clone(),
            do3inp: self.do3inp.clone(),
            dn2oinp: self.dn2oinp.clone(),
            dnoyi_np: self.dnoyi_np.clone(),
            zin: self.zin.clone(),
            xin: self.xin.clone(),
            pin_t: self.pin_t.clone(),
            tfull: self.tfull.clone(),
            fbrx_ref: self.fbrx_ref.clone(),
            zjh2o: self.zjh2o.clone(),
            xjh2o: self.xjh2o.clone(),
            xjdo: self.xjdo.clone(),
            nwalb: self.nwalb.clone(),
            izalb: self.izalb.clone(),
            nztr: self.nztr.clone(),
            iwn2o: self.iwn2o.clone(),
            iwnoy: self.iwnoy.clone(),
            iwbry: self.iwbry.clone(),
            ...
            out_unit8: None,
            out_unit9: None,
            fort01_remaining: self.fort01_remaining.clone(),
            fort13_lines: self.fort13_lines.clone(),
            fort14_lines: self.fort14_lines.clone(),
        }
    }
}
